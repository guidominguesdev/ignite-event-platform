  ...
  return (
    ...
    >
      ...
      >
        ...
        <div
          className={classNames('rounded transition-colors relative border border-gray-500 p-4 mt-2', {
        ...
        >
          ...
          <div
            className={classNames(
              'bg-green-500 rounded-[2px] absolute rotate-45 top-0 left-[-6px] bottom-0 my-auto w-[12px] h-[12px]',
              {
